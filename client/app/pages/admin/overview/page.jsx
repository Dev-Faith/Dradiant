  ...
  return (
    <div className="xl:w-full px-[28px] pb-[28px] xl:p-[28px] h-full flex flex-col flex-1 gap-[45px] overflow-hidden">
      <div className="middle flex xl:flex-row flex-col items-center justify-center xl:justfiy-between gap-[20px]">
        ...
        <div className="right flex w-full xl:flex-row flex-col items-center xl:w-[439px] gap-[20px] justify-center xl:justify-between">
          <div className="warning flex hidden xl:flex items-center w-[300px] cursor-pointer justify-center hover:underline">
