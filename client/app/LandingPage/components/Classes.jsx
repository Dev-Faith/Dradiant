...
const Classes = () => {
  return (
    <div className="xl:pt-[164px]  pt-[68px] md:pt-[120px] xl:px-[124px] md:px-[50px] px-[11px] flex flex-col xl:gap-[98px] gap-[21px] ">
       <div className=" top flex xl:flex-row flex-col md:flex-row  xl:items-center items-start justify-between md:items-end">
        ...
        <div className="relative md:my-[64px]">
              ...
              <button className="border-[1px] border-[#FFF9EB] text-[#FFF9EB] xl:text-[89px] text-[29px]/[64px] px-[24px] xl:py-[32px] py-[8px] absolute xl:top-[60%] top-[60%] xl:right-[30%] lg:right-[40%] md:right-[35%] right-[20%] hover:bg-[#FFF9EB] hover:text-[#201C00] transition ease-in">LEARN NOW</button>
        </div>
    </div>
  )
}
